...
import com.otaliastudios.elements.sample.sources.PlaygroundSource
import java.util.*

class PlaygroundPresenter(context: Context) : SimplePresenter<PlaygroundSource.Data>(context, R.layout.item_playground, 0, { view, item ->
